...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body
        className={`${inter.className}  bg-gray-100 text-gray-950 pt-24 sm:pt-28 !scroll-smooth scroll-py-[20rem] dark:bg-gray-500 dark:text-gray-50 dark:text-opacity-90 `}
      >
        ...
        <Activesectioncontext>
          <ThemeContext>
            <Toaster />
            <div className="w-full max-w-4xl grid mx-auto px-2">
              <Header />
              {children}
              <Footer />
            </div>
